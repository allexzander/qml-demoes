        ...
        Rectangle {
            ...
            MouseArea {
                ...
                onPositionChanged: {
                    ...
                    var lastAngleMinus2Pi = handle.lastAngle < 0 ? (handle.lastAngle + 2*Math.PI) : (handle.lastAngle - 2*Math.PI);

                    if (Math.abs(angleMinus2Pi - lastAngleMinus2Pi) >= arcCanvas.tooMuchAngleChangeLimit) {
                        return
                    }
